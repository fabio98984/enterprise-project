...
<body>
  		...
  		<div class="container">
  			<div class="row justify-content-center">
  				<div class="col-md-6 text-center mb-5">
  					<h2 class="heading-section">OPEN SOURCE SYSTEMS</h2>
            <div class="test">
            ...
            <form action="record-delete.php" method="post">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = 'SELECT id, dName, ksb, name, mime, size, data, created FROM open';
                    ...
                    if ($result-> num_rows > 0) {
                      while ($row = $result-> fetch_assoc()) {
                        ...
                        <td><button type='submit' name='delete_open' id='delete' class='example_c' value='Delete Records'>Delete</button></td>
                        </tr>";
                      }
    ...
    <div class="popup" id="popup-1">
        ...
        <div class="content">
          ...
          <p>
            <form action="add-open.php" method="post" enctype="multipart/form-data">
